...
use crate::mm::{PageBox, SVSM_PERTASK_SHADOW_STACK_BASE, SVSM_PERTASK_SHADOW_STACK_BASE2};
...
impl Task {
    pub fn create(cpu: &PerCpu, entry: extern "C" fn()) -> Result<TaskPointer, SvsmError> {
        ...
        let (shadow_stack, shadow_stack_offset) = VMKernelShadowStack::new(
        ...
        let (shadow_stack, shadow_stack_offset2) =
            VMKernelShadowStack::new(SVSM_PERTASK_SHADOW_STACK_BASE2, ShadowStackInit::Exception)?;
        vm_kernel_range.insert_at(
            SVSM_PERTASK_SHADOW_STACK_BASE2,
            Arc::new(Mapping::new(shadow_stack)),
        )?;
        ...
        Ok(Arc::new(Task {
            ...
            exception_shadow_stack: shadow_stack_offset2,
            stack_bounds: bounds,
